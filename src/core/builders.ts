...
export const MOLECULES: Record<MoleculeParams['kind'], MoleculeDef> = {
  ...
  // 甲苯（2026-09-17）：PubChem CID 1140 3D 构象（MMFF94，OEChem 生成）逐位转录，
  // 数据源存档 data/toluene.sdf。芳 C–C ≈1.395、环–CH₃ ≈1.492、芳 C–H ≈1.087、
  // 甲基 C–H ≈1.095；苯环 6 碳共面（z 偏差 <0.001Å）。原子序 0–6 = C（3 为 CH₃ 碳）、7–14 = H
  'C₇H₈': {
    atoms: [
      { el: 'C', x: -0.9825, y: 0.0, z: 0.0001 },
      { el: 'C', x: -0.285, y: 1.2079, z: 0.0001 },
      { el: 'C', x: -0.2852, y: -1.2079, z: 0.0 },
      { el: 'C', x: -2.4741, y: 0.0001, z: -0.0002 },
      { el: 'C', x: 1.1099, y: 1.208, z: -0.0001 },
      { el: 'C', x: 1.1097, y: -1.208, z: 0.0 },
      { el: 'C', x: 1.8072, y: 0.0, z: -0.0001 },
      { el: 'H', x: -0.8169, y: 2.1557, z: -0.0017 },
      { el: 'H', x: -0.8172, y: -2.1556, z: -0.0018 },
      { el: 'H', x: -2.8694, y: -0.8801, z: 0.5183 },
      { el: 'H', x: -2.8694, y: 0.8808, z: 0.5175 },
      { el: 'H', x: -2.8495, y: -0.0004, z: -1.0283 },
      { el: 'H', x: 1.6531, y: 2.1484, z: -0.0007 },
      { el: 'H', x: 1.6529, y: -2.1485, z: -0.0005 },
      { el: 'H', x: 2.8933, y: -0.0001, z: -0.0004 },
    ],
    bonds: [
      [0, 1], [0, 2], [0, 3],
      [1, 4], [1, 7],
